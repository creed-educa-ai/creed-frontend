    ...
    <Provider store={store}>
      <MemoryRouter initialEntries={[rota]}>
        <Routes>
          ...
          <Route path="/questionario" element={<p>prévia do questionário</p>} />
        </Routes>
      </MemoryRouter>
    </Provider>,
  );
...
describe('fluxo dos dados demográficos', () => {
  ...
  it('percorre as três etapas até a prévia do questionário', async () => {
    ...
    expect(
      await screen.findByText('prévia do questionário'),
    ).toBeInTheDocument();
  });
